...
A big focus of my talk 2 years ago was on the importance of reproducibility and open science in transport research.
Open science, including sharing code, data and results in accessible formats, increases trust in research findings, makes work more generalisable and 'internationalisable', makes it easier for others to build on research, and can help democratise transport planning [@lovelace2020].
For Mobile Tartu 2026 I was invited to [deliver a workshop](https://robinlovelace.net/events/mobile-tartu-2026/) for the PhD school that precedes the conference and I naturally made open science a key theme in the workshop.
The result was a 2-day course on Data Science for Transport Planning delivered by me and my ITS colleague and PhD student Juan Fonseca, shown in the photo.
...
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7469324956632510464?collapsed=1" height="645" width="504" frameborder="0" allowfullscreen title="Embedded post">
...
This time we focussed specifically on using origin-destination data from the [{spanishoddata} R package](https://ropenspain.github.io/spanishoddata/) [@kotov_spanishoddata_2026].
...
1.  **Leisure and Commuting Mobility Patterns in the Spain-France Border Region** — Eva Hajčiarová, Paul Bairoh, Allison Fernández-Lobo, Juliette Le Corguillé. [Slides](https://tdscience.github.io/tartu26/group1.html)
2.  **Cross-Border Flows Between France and Spain through Catalonia** — Mariana Montero Vega, Leonardo Moreira, Juan Arquero Gallego, Keren Or Rosenbaum. [Slides](https://tdscience.github.io/tartu26/group2.html)
3.  **Cross-Border Trip Purposes, Bike-Sharing & Public Transport Strikes, and OD Flow Validation** — Jonas Wübbenhorst, Helen Tera, Xiao Cai, Jaanika Jaanits. [Slides](https://tdscience.github.io/tartu26/group3.html)
4.  **How Is Human Mobility Driven By Amenities? A Pamplona Case Study** — Zijun Ding, Thomas Dimos, Laura Altin, Emiliano Beltran. [Slides](https://tdscience.github.io/tartu26/group4.html)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/3uCvPyB43rU?si=hc8NGRbbXp7LA-q0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
...
The course repository now has 10+ contributors and should help inspire future work and teaching.

<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7470000166335340545?collapsed=1" height="669" width="504" frameborder="0" allowfullscreen title="Embedded post">

</iframe>

A key decision that we made early on with the teaching was to use [Devcontainers](https://containers.dev/) to provide a consistent environment for all participants.
Despite some initial hiccups, this seems to have worked well, enabling people new to coding and GitHub to get up and running quickly, and allowing us to focus on the research questions rather than technical issues.
A key lesson learned for anyone thinking of using Devcontainers: setup can take time, so it's worth using a pre-existing container and devcontainer.json settings.
Use a tried-and-tested container such as the [itsleeds/tds](https://github.com/itsleeds/tds) container used in this workshop, or the [geocompx/docker](https://github.com/geocompx/docker) container that it builds on, rather than trying to build your own from scratch.
See the [source code for our workshop](https://github.com/tdscience/tartu26) for the devcontainer.json settings we used and feel free to adapt them for your own workshops.
...
The rest of the conference was great, including standard presentations by researchers from a wide range of backgrounds.
The quality of the research presented was high, and there was lots to learn.
There was also a poster session, providing a good way for researchers to present their work one-to-one and get feedback.
...
Another great thing about the conference is how good the organising team, and the Mobility Lab in general, is at getting the work out there, meaning people who cannot attend in person can still benefit from the research presented.
It's in that spirit that I have shared this write-up, and provide some more links below.

-   The [Mobility Lab YouTube channel](https://www.youtube.com/@mobilitylab7937) has keynotes from the conference
-   The [Mobile Tartu 2026 conference website](https://mobiletartu.ut.ee/) has links to the conference programme and abstracts
-   The [`madina` Python package](https://github.com/City-Form-Lab/madina) for modelling pedestrian movements, which was the focus of Andres Sevtsuk's workshop
-   Course materials for the [Data Science for Transport Planning](https://tdscience.github.io/tartu26/) workshop delivered by me and Juan

Thanks to everyone for making it such a great event, and hope to see you at the next one in 2028!

<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7470474608744509441?collapsed=1" height="603" width="504" frameborder="0" allowfullscreen title="Embedded post">
