...
<div class="tab-content" id="bio-tabs-content">
  <div class="tab-pane fade show active" id="bio-pane" role="tabpanel" aria-labelledby="bio-tab" tabindex="0">
    <p>I am a [Professor of Transport Data Science](https://environment.leeds.ac.uk/transport/staff/953/dr-robin-lovelace) at the [University of Leeds](https://www.leeds.ac.uk/) [Institute for Transport Studies](https://environment.leeds.ac.uk/transport), where I build open tools and reproducible workflows for evidence-based transport planning.</p>
    
    <p>I share code, methods, and writing on [GitHub](https://github.com/robinlovelace) and in the [posts section](/posts/). If you would like to collaborate, feel free to [email me](mailto:r.lovelace@leeds.ac.uk).</p>
